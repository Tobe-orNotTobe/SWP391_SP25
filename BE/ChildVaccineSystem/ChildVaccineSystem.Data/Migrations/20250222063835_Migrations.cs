    ...
    public partial class Migrations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ServicePackageId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VaccineScheduleDetail", x => x.VaccineScheduleDetailId);
                    table.ForeignKey(
                        name: "FK_VaccineScheduleDetail_VaccinationSchedules_ScheduleId",
                        column: x => x.ScheduleId,
                        principalTable: "VaccinationSchedules",
                        principalColumn: "ScheduleId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VaccineScheduleDetail_Vaccines_VaccineId",
                        column: x => x.VaccineId,
                        principalTable: "Vaccines",
                        principalColumn: "VaccineId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingDetails_ComboVaccines_ComboId",
                        column: x => x.ComboId,
                        principalTable: "ComboVaccines",
                        principalColumn: "ComboId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InjectionSchedules_VaccineScheduleDetail_VaccineScheduleDetailId",
                        column: x => x.VaccineScheduleDetailId,
                        principalTable: "VaccineScheduleDetail",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VaccineScheduleDetail_ScheduleId",
                table: "VaccineScheduleDetail",
                column: "ScheduleId");

            migrationBuilder.CreateIndex(
                name: "IX_VaccineScheduleDetail_VaccineId",
                table: "VaccineScheduleDetail",
                column: "VaccineId");
        }
